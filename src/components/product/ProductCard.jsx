...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="group flex flex-col rounded-2xl border border-navy-900/10 bg-white p-3 shadow-sm transition-shadow hover:shadow-md">
      <div className="relative overflow-hidden rounded-xl bg-cream-50">
        ...
        <img src={image} alt={name} className="aspect-square w-full object-cover transition-transform duration-300 group-hover:scale-105" />
      </div>
