...
//   return (
//     <div className="group relative overflow-hidden rounded-2xl bg-white shadow-sm transition-shadow hover:shadow-md">
//       {badge && (
//         <span className="absolute left-3 top-3 z-10 rounded-full bg-brand-blue px-2.5 py-1 text-xs font-semibold text-white">
//           {badge}
//         </span>
//       )}
...
//           type="button"
//           aria-label="Add to wishlist"
//           className="flex h-9 w-9 items-center justify-center rounded-full bg-white shadow-md hover:text-brand-blue"
//         >
//           <FiHeart size={17} />
//         </button>
...
//       >
//         <div className="aspect-square overflow-hidden bg-navy-900/5">
//           <img
//             src={image}
//             alt={name}
