const Eyebrow = ({ children }) => {
 ...
 <span className="block rounded-full bg-[linear-gradient(90deg,#D9E4FF_0%,rgba(255,255,255,0)_100%)] px-4 py-1.5 text-sm font-semibold  tracking-wide text-brand-blue sm:text-base md:text-[16px]">
    {children}
  </span>
</div>
  );
