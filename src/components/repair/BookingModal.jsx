...
const APPLIANCE_OPTIONS = [
  {
    ...
    icon: ApplianceIcons.washingMachine,
  },
  { id: "washer-dryer", name: "Washer Dryer", icon: ApplianceIcons.washingMachine },
  { id: "tumble-dryer", name: "Tumble Dryer", icon: ApplianceIcons.dryer },
  { id: "electric-cooker-oven", name: "Electric Cooker / Electric Oven", icon: ApplianceIcons.cooker },
  { id: "fridge-freezer", name: "Fridge Freezer", icon: ApplianceIcons.fridge },
  { id: "fridge", name: "Fridge", icon: ApplianceIcons.fridge },
  { id: "freezer", name: "Freezer", icon: ApplianceIcons.fridge },
...
const BookingModal = ({ isOpen, onClose }) => {
  ...
  const currentApplianceName =
    APPLIANCE_OPTIONS.find((a) => a.id === selectedAppliance)?.name ||
    "Appliance";
  ...
  const handleNext = () => {
    ...
    if (step === 1) {
      ...
      if (!applianceAge) {
        setErrorMessage("Please select how long you have had the appliance.");
        return;
      }
      setStep(3);
    } else if (step === 3) {
        ...
        {step === 5 ? (
          <div className="py-4 text-center">
            ...
            <p className="mt-2 text-xs sm:text-sm text-slate-500 max-w-sm mx-auto">
              Your repair has been successfully booked. A confirmation email has
              been sent to{" "}
              <strong className="text-navy-950 block mt-0.5">
              ...
              <div className="mt-4 space-y-3.5 text-xs sm:text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold text-navy-950 text-right max-w-[200px] truncate">
                    {fullAddress || "42 Privet Drive, London"},{" "}
                    {postcode || "GU1 1AA"}
                  </span>
                </div>
          ...
          <div>
            <div>
              ...
              <h2 className="mt-1 font-display text-xl sm:text-2xl font-bold text-navy-950">
                {step === 1 && "Select Your Appliance"}
                {step === 2 && "Fault Details"}
                {step === 3 && "Your Details"}
                {step === 4 && "Choose Your Appointment"}
              </h2>
            </div>
            ...
            <div className="mt-5 border-b border-slate-100 pb-5">
              <div className="flex flex-wrap items-center justify-between gap-2 text-[10px] sm:text-xs">
                <div className="flex items-center gap-1.5">
                  ...
                  <span
                    className={`font-medium ${step === 1 ? "text-navy-950 font-bold" : "text-slate-500"}`}
                  >
                    Appliance
                  </span>
                </div>
                ...
                <div
                  className={`h-px flex-1 mx-2 ${step > 1 ? "bg-emerald-500" : "bg-slate-200"}`}
                />
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span
                    className={`font-medium ${step === 2 ? "text-navy-950 font-bold" : "text-slate-500"}`}
                  >
                    Fault Details
                  </span>
                </div>
                ...
                <div
                  className={`h-px flex-1 mx-2 ${step > 2 ? "bg-emerald-500" : "bg-slate-200"}`}
                />
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span
                    className={`font-medium ${step === 3 ? "text-navy-950 font-bold" : "text-slate-500"}`}
                  >
                    Your Details
                  </span>
                </div>
                ...
                <div
                  className={`h-px flex-1 mx-2 ${step > 3 ? "bg-emerald-500" : "bg-slate-200"}`}
                />
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span
                    className={`font-medium ${step === 4 ? "text-navy-950 font-bold" : "text-slate-500"}`}
                  >
                    Appointment
                  </span>
                </div>
            ...
            {step === 3 && (
              <div className="mt-5 space-y-3.5">
                <p className="text-xs sm:text-sm text-slate-600">
                  Your personal and address{" "}
                  <span className="text-brand-blue font-semibold">details</span>
                  .
                </p>
